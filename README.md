...
The code in this repository fully replicates the experiments showcased in our paper. We also provide code for additional experiments on GNDE reaction-diffusion dynamics transfer with full training pipelines. The corresponding work is under review.
